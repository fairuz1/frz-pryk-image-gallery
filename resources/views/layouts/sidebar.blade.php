    ...
    {{-- <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item" style="color: white !important;">
                <button class="nav-link active" id="pills-home-tab" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                    <img class="nav-icon" src="{{ asset('icons/ic_home.svg') }}" alt="">
                    Home
                </button>
            </li>
            <li class="nav-item">
